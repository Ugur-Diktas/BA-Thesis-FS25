...
*To set working directory otherwise it does not work correctly
cd "${root}"
...
do "${dodir_par_stu}/5_ps_students_clean_other.do"
do "${dodir_par_stu}/6_ps_students_merge_chars.do"
do "${dodir_par_stu}/7_ps_students_clean_parent_occs.do"
do "${dodir_par_stu}/8_ps_students_drop_vars.do"
do "${dodir_par_stu}/9_ps_students_clean_motivations.do"
...
do "${dodir_par_par}/5_ps_parents_clean_other.do"
do "${dodir_par_par}/6_ps_parents_merge_chars.do"
do "${dodir_par_par}/7_ps_parents_clean_parent_occs.do"
do "${dodir_par_par}/8_ps_parents_drop_vars.do"
do "${dodir_par_par}/9_ps_parents_clean_motivations.do"
