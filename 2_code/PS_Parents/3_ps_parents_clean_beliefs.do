...
// Purpose: Cleans the randomised "belief" or "fit" questions for parents
...
set more off
cap log close
log using "${dodir_log}/ps_parents_clean_beliefs.log", replace

* 1. Load the step-2 data
use "${processed_data}/PS_Students/temp_parents_step2.dta", clear
...
* 3. Save
save "${processed_data}/PS_Students/temp_parents_step3_beliefs.dta", replace
