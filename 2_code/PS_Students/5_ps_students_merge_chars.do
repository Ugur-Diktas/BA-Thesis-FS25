...
// Purpose: Merges the students data with your skill_intensity_data
...
set more off
cap log close
log using "${dodir_log}/ps_students_merge_chars.log", replace

* 1. Load data from step 4
use "${processed_data}/PS_Students/temp_students_step4_other.dta", clear
...
* 4. Save
save "${processed_data}/PS_Students/temp_students_step5_chars.dta", replace
