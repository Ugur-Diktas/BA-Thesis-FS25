...
//    For each preference variable, use its _code as the merge key to append
...
foreach p of local pref_vars {
    ...
    // Rename the labb_code back to the original preference code
    // This fixes the ambiguous variable error
    drop temp_merge_key
